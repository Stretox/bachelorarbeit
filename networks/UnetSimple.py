# Implementation by https://github.com/KeyuWu-CS/MonoHair
...
class UNetSimple(nn.Module):
    def __init__(self, in_channels, num_chan=(8, 16, 32, 64), ksize = 3): # (16, 32, 64, 128)
        super(UNetSimple, self).__init__()

        self.inc = DoubleConv(in_channels, num_chan[0], ksize)
